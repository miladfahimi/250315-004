            ...
            <ul class="nav-links">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu submenu" id="submenu-shoes">
                  <li><a href="#" class="back-to-main"><i class="fas fa-chevron-right"></i> <span>کفش تنیس</span></a>
                  </li>
          ...
          <div class="nav-left-phones">
            <div class="nav-account">
              <a href="#" class="nav-account-toggle" id="accountToggle">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/user-icon.png" alt="حساب کاربری">
                <span class="login-text"> ورود/عضویت</span>
              </a>
              <ul class="nav-account-menu" id="accountDropdown">
                <li><a href="<?php echo esc_url(wp_login_url()); ?>"><span>حساب کاربری</span> <i
                      class="fas fa-chevron-left"></i></a></li>
                <li><a href="<?php echo esc_url(wp_logout_url(home_url())); ?>"><span> خروج</span><i
                      class="fas fa-chevron-left"></i> </a></li>
              </ul>
            </div>
        ...
        <div class="nav-center">
          <div class="search-box">
            <form action="<?php echo esc_url(home_url('/')); ?>" method="get">
              <input type="text" name="s" placeholder="دنبال چه محصولی هستید؟"
                value="<?php echo get_search_query(); ?>">
              <button type="submit"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/search.png"
                  alt="جستجو"></button>
            </form>
          </div>
        </div>
