...
<section class="elite-collection">
  <div class="elite-top"
    style="background-image: url('<?php echo esc_url(get_template_directory_uri() . "/assets/images/top-image.png"); ?>');">
  </div>

  <div class="elite-bottom">
    <div class="elite-item"
      style="background-image: url('<?php echo esc_url(get_template_directory_uri() . "/assets/images/bottom-left.jpg"); ?>');">
    ...
    <div class="elite-item"
      style="background-image: url('<?php echo esc_url(get_template_directory_uri() . "/assets/images/bottom-right.jpg"); ?>');">
      <div class="elite-overlay">
