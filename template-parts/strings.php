...
<section class="string-section">
  <div class="main-container">
    ...
    <div class="msv-card">
      <div class="msv-image"
        style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/msv-bg.jpg');"></div>
      ...
      <div class="string-carousel">
        <div class="string-grid">
          ...
          <?php while ($strings_query->have_posts()) : $strings_query->the_post();
              ...
              $string_price = $product->is_type('variable') ? $product->get_variation_price('min', true) : $product->get_price();
